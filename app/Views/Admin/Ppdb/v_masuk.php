...
<div class="col-sm">
    ...
    <div class="card card-primary">
        ...
        <!-- Card -->
        <div class="card-body card-primary p-1 justify-content-center text-center">
            <table class="table table-striped projects mt-1" id="example1">
                ...
                if ($pesan) : ?>
                    ...
                    <?= '</div>'  ?>
                <?php endif; ?>
                <?php $pesan =  session()->getFlashdata('ditolak');
                if ($pesan) : ?>
                ...
                <tbody>
                    ...
                    foreach ($ppdb as $key => $value) : ?>
                        <tr>
                            <td><?= $no++; ?></td>
                            <td> <img alt="Avatar" class=" img-thumbnail  " width="128px" height="286px" src="<?= base_url('img/user' . '/' . $value['foto']) ?>"></td>
                            <td><?= $value['tahun']; ?></td>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('/Ppdb/diterima') . '/' . $value['id_siswa'] ?>" class="btn btn-flat btn-success">Terima</a>
                                <a href="<?= base_url('/Ppdb/ditolak') . '/' . $value['id_siswa'] ?>" class="btn btn-flat btn-danger">Tolak</a>
